...
// Define tạm 2 roles cho user, tuỳ việc mở rộng dự án như thế nào mà mọi người có thể thêm role tuỳ ý cho phù hợp sau.
const USER_ROLES = {
  CLIENT: 'client',
  ADMIN: 'admin'
}
...
const USER_COLLECTION_SCHEMA = Joi.object({
  ...
  // username cắt ra từ email sẽ có khả năng không unique bởi vì sẽ có những nền tảng email trùng nhau ở các nhà cung cấp khác nhau.
